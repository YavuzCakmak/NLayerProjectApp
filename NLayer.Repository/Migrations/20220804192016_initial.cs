    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2022, 8, 4, 22, 20, 16, 484, DateTimeKind.Local).AddTicks(225), "Kalem 1", 100m, 20, null },
                    { 2, 1, new DateTime(2022, 8, 4, 22, 20, 16, 484, DateTimeKind.Local).AddTicks(277), "Kalem 2", 100m, 20, null },
                    { 3, 2, new DateTime(2022, 8, 4, 22, 20, 16, 484, DateTimeKind.Local).AddTicks(282), "Kitap 1", 100m, 20, null },
                    { 4, 2, new DateTime(2022, 8, 4, 22, 20, 16, 484, DateTimeKind.Local).AddTicks(285), "Kitap 2", 100m, 20, null }
                });
